...
class AuthState extends ChangeNotifier {
  ...
  /// Perform username & password login (Worker/HKS).
  Future<bool> loginWorker(String username, String password) async {
    _setStatus(AuthStatus.loading);
    try {
      final user = await _repository.loginWorker(username, password);
      _user = user;
      _setStatus(AuthStatus.authenticated);
      return true;
    } catch (e) {
